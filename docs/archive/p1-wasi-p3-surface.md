# WASI 0.3 surface (P1) — archived

**English** | [中文](p1-wasi-p3-surface.zh.md)

> **Closed 2026-08-26.** Current work: [`../agent/wasmtime-p2.md`](../agent/wasmtime-p2.md). Close-out: [`p1-wasi-p3.md`](p1-wasi-p3.md). Leftover shapes: [`../mapping/gap-wasi-p3-wit.md`](../mapping/gap-wasi-p3-wit.md).

Companion to [`../scheme/long-term-plan.md`](../scheme/long-term-plan.md) **P1** (closed). Playbook (archived): [`p1-wasi-p3-playbook.md`](p1-wasi-p3-playbook.md).
