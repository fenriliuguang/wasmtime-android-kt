...
- 禁止：WebFetch WIT、无 offset 读 `cm.rs`/`jvm.rs`、横向扫第三份模板、改 hub 文件、crate `cargo fmt`、全量 native 测试、设备仪器、在本手册加深 `gpu-canvas-context`/S1–S3/`record-*`、一条 PR 吞掉整个 resource、新增 `HostArg` 变体
