...
- 禁止：WebFetch WIT、无 offset 读 `cm.rs`、横向扫第三份测试、改 hub 文件、crate `cargo fmt`、全量 native 测试、设备仪器、新 JNI、把 `gpu-canvas-context` 混进本手册（canvas 走 [`webgpu-midterm.md`](webgpu-midterm.md)）、改 README Transitional 长段
