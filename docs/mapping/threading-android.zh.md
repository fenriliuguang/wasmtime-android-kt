...
帧循环形状笔记（gfx RFC / 非 P2 刀）：[`frame-loop-suggestion.zh.md`](frame-loop-suggestion.zh.md)。节拍同步：[`gfx-hitch-checklist.zh.md`](gfx-hitch-checklist.zh.md)。`0.1.0` 门禁：[`../scheme/rfc-wasi-gfx-frame-loop.md`](../scheme/rfc-wasi-gfx-frame-loop.md)。
