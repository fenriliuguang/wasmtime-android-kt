...
Living map for the **in-process Dawn C** consume path (`NativeGpu`). Pin: `wasi:webgpu@0.3.0-rc.2`. JNI leftover: [`gap-webgpu-wit-androidx.md`](gap-webgpu-wit-androidx.md). Playbook: [`../agent/native-dawn.md`](../agent/native-dawn.md). Product claim (not CTS): [`../scheme/claim-010.md`](../scheme/claim-010.md) — default degree is **Dawn C**, not “instantiate via JNI”. Do not treat this page as a cut queue — needles stay in [`../scheme/native-dawn.md`](../scheme/native-dawn.md). Beat sync: [`gfx-hitch-checklist.md`](gfx-hitch-checklist.md).
