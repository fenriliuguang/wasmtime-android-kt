...
| Pipeline / Bind group | render/compute pipeline | **W3** `[method]gpu-device.create-bind-group-layout` sync 已交付（host 固定空 entries，仍 u32）；pipeline / bind-group 仍后 |
