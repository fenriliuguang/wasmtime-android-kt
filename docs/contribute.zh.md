...
禁止引入 wasmtime4j 作为运行时。用户可见变更只写 `changelog/unreleased/` 碎片。形状刀见 [`agent/webgpu-shape-slice.md`](agent/webgpu-shape-slice.md)。语义 L2 见 [`agent/webgpu-semantic-l2.md`](agent/webgpu-semantic-l2.md)。
