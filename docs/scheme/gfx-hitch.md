...
After HP-BIND: compositor/acquire **SF counters landed 2026-09-02** (mapping §6.7; no knob). **Eye close 2026-09-02:** out-of-tree guest Taylor/`wrap_pi` (~4.19 s) then shared-Euler `fold_pi` snap (mapping §6.9). Named leftover for *this* pop is **empty**. Do not restack keep-N / DisplayManager / GameState / JNI for it. P2 Wasmtime, CTS, this-repo **1.0.0** stay named-only.
