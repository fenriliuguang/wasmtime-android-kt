...
Cube / out-of-tree demo is **not** a consume needle. Consume leftover is **empty**. Living leftover is **empty**.
...
Cube-only hot path (not this table), `AChoreographer`, core pin, G-cmd, testsuite, `wasmtime-wasi`, CTS, this-repo **1.0.0**, P0/P1 re-cuts, Wasmtime **major**.
