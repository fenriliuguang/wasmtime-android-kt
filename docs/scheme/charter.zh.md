...
首发提案世界：规范形状的 [`wasi:webgpu`](https://github.com/WebAssembly/wasi-webgpu)（WIT + 真 CM async；**P0 已关闭**）。P1 WASI 0.3 **已关闭**。现行队列 **`0.1.0` 完整帧循环**（**P010-GFXB** → **P010-GFXV**）然后 **P010-DEMO**。P2 Wasmtime 钉为点名。运行时不永远绑死单一 world。
