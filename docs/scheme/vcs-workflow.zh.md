...
| 已合切片 / 下一刀 | **不在本页追加清单**。活状态：[Project](https://github.com/users/fenriliuguang/projects/1)；规格见 [`guest-shape.md`](guest-shape.md)、[`wasi-p3-surface.md`](wasi-p3-surface.md)、[`roadmap-wasi-webgpu.md`](roadmap-wasi-webgpu.md)；已合行为见 [`changelog/unreleased/`](../../changelog/unreleased/) |
