...
- [x] 贡献者构建文档；可选桌面开发壳（[`../contribute.md`](../contribute.md) + `build-native-host.ps1`；2026-08-11）  
- [x] 是否支持更多 WASI world 的路线图（[`rfc-wasi-worlds.md`](rfc-wasi-worlds.md)；2026-08-11）  
