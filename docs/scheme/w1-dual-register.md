...
> **W3+ 本片：** 已注册 **`[method]gpu-device.create-pipeline-layout`**（**sync**，host 固定空 bind-group-layouts；返回仍为过渡 u32，非 `gpu-pipeline-layout` resource）。
