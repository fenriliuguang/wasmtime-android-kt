...
> **W3+ 本片：** 已注册 **`[method]gpu-device.create-shader-module`**（**sync**，host 固定 stub WGSL；返回仍为过渡 u32，非 `gpu-shader-module` resource）。
