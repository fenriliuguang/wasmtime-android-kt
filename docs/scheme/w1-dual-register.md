...
> **W3+ 本片：** 已注册 **`[method]gpu-render-pass-encoder.set-bind-group`**（**sync** void；JNI 忽略 Guest stub bind-group；host 固定空 bind-group index 0 + Cpu 离屏 view）。
