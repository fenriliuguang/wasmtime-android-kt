...
`python3 ./scripts/wasi-p3-leftover-remaining.py` 打印 **Next: (WASI 0.3 leftover empty)**。NativeGpu Remaining Table 是**另一**自动队列：`python3 ./scripts/nativegpu-remaining.py`。
