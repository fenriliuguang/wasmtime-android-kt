...
钉版 **`wasi:webgpu@0.3.0-rc.2`**。**P0 已关闭**（[`../archive/p0-wasi-webgpu.zh.md`](../archive/p0-wasi-webgpu.zh.md)）。androidx 空洞：[`../mapping/gap-webgpu-wit-androidx.zh.md`](../mapping/gap-webgpu-wit-androidx.zh.md)。现行工作：[`../agent/native-dawn.md`](../agent/native-dawn.md)（同一钉，Dawn C 消费）。
