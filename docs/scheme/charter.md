...
See [`long-term-plan.md`](long-term-plan.md): L0–L5. P0 (L3 wasi:webgpu shape) is **closed**. P1 (WASI 0.3) is **closed**. **`0.1.0` remaining** is the complete gfx frame loop (**P010-GFXB** → **P010-GFXV**) ([`../agent/product-010.md`](../agent/product-010.md)). P2 Wasmtime pin is **named**. L4 is citable host. **L5 is accepted** (0.x product subset; coordinates `0.1.0`).
