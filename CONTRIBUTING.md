...
| [`docs/blocked-gpu-host.md`](docs/blocked-gpu-host.md) | Unpublished GPU host — **do not delete in a docs PR** |
...
| `jvm (runtime-api compile)` | `:runtime-api:compileKotlin` |

New integration tests: only add `native/tests/<name>.rs`. Do not edit `ci.yml`.
