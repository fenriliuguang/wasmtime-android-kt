...
- Guest `fixtures/p3/stream_chunks`: three 4-byte `stream.write` of `P3C1P3C2P3C3`; host `take-chunks` pipes a 2-byte-per-poll `StreamConsumer` (backpressure). Not a second copy of the 4-byte `P3ST` / `P3WR` smokes
