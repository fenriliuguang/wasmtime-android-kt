...
- Replace shape / semantic-L2 / midterm agent playbooks with [`docs/archive/webgpu-guest-pipeline.md`](../../docs/archive/webgpu-guest-pipeline.md) (P1 bind-group entries → P5 texture mip/sample/dimension). Archived 2026-08-22.
