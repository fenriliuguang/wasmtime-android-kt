...
interface ExperimentalHostCallbacks {
    ...
    fun renderPipelineLabelDescribed(handle: Int): String = unsupported("renderPipelineLabelDescribed")

    /** L2: Guest gpu-render-pipeline handle + label string. */
    fun renderPipelineSetLabelDescribed(handle: Int, label: String) {
        unsupported("renderPipelineSetLabelDescribed")
    }

    /** L2: Guest gpu-render-pass-encoder handle → WIT `gpu-render-pass-encoder.label`. */
    fun renderPassEncoderLabelDescribed(handle: Int): String = unsupported("renderPassEncoderLabelDescribed")

    /** L2: Guest gpu-render-pass-encoder handle + label string. */
    fun renderPassEncoderSetLabelDescribed(handle: Int, label: String) {
        unsupported("renderPassEncoderSetLabelDescribed")
    }
    ...
    fun renderBundleEncoderSetLabelDescribed(handle: Int, label: String) {
        unsupported("renderBundleEncoderSetLabelDescribed")
    }

    /** L2: Guest gpu-compute-pipeline handle → WIT `gpu-compute-pipeline.label`. */
    fun computePipelineLabelDescribed(handle: Int): String = unsupported("computePipelineLabelDescribed")

    /** L2: Guest gpu-compute-pipeline handle + label string. */
    fun computePipelineSetLabelDescribed(handle: Int, label: String) {
        unsupported("computePipelineSetLabelDescribed")
    }

    /** L2: Guest gpu-compute-pass-encoder handle → WIT `gpu-compute-pass-encoder.label`. */
    fun computePassEncoderLabelDescribed(handle: Int): String = unsupported("computePassEncoderLabelDescribed")

    /** L2: Guest gpu-compute-pass-encoder handle + label string. */
    fun computePassEncoderSetLabelDescribed(handle: Int, label: String) {
        unsupported("computePassEncoderSetLabelDescribed")
    }

    /** L2: Guest gpu-command-buffer handle → WIT `gpu-command-buffer.label`. */
    fun commandBufferLabelDescribed(handle: Int): String = unsupported("commandBufferLabelDescribed")

    /** L2: Guest gpu-command-buffer handle + label string. */
    fun commandBufferSetLabelDescribed(handle: Int, label: String) {
        unsupported("commandBufferSetLabelDescribed")
    }
    ...
    fun deviceSetLabelDescribed(handle: Int, label: String) {
        unsupported("deviceSetLabelDescribed")
    }
    ...
    fun samplerSetLabelDescribed(handle: Int, label: String) {
        unsupported("samplerSetLabelDescribed")
    }
    ...
    fun textureSetLabelDescribed(handle: Int, label: String) {
        unsupported("textureSetLabelDescribed")
    }
    ...
    fun compilationMessageLengthDescribed(shader: Int): Long =
        unsupported("compilationMessageLengthDescribed")
    ...
    /**
     * L2: Guest layout handle + entries (parallel binding/kind/handle arrays) + optional label.
     * kind: 0 = buffer, 1 = sampler, 2 = texture-view. Empty arrays stay valid.
     */
    fun deviceCreateBindGroupDescribed(
        device: Int,
        layout: Int,
        label: String,
        bindings: IntArray,
        kinds: IntArray,
        handles: IntArray,
    ): Int = unsupported("deviceCreateBindGroupDescribed")
    ...
    fun beginRenderPassDescribed(
        ...
        hasDepthClear: Int,
        depthClear: Float,
    ): Int = unsupported("beginRenderPassDescribed")
