...
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (type $ty-fn (func (param "self" $borrow-gpu) (result 1)))
    (export "[method]gpu.get-preferred-canvas-format" (func (type $ty-fn)))
    (type $own-gpu (own $gpu))
    (export "get-gpu" (func (result $own-gpu)))
  ))
  (alias export $webgpu "get-gpu" (func $get-gpu))
  (alias export $webgpu "[method]gpu.get-preferred-canvas-format" (func $meth))
