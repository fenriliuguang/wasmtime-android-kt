...
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (type $list-f64 (list f64))
    (type $meth-ty (func (param "self" $borrow-rec) (result $list-f64)))
    (export "[method]record-gpu-pipeline-constant-value.values" (func (type $meth-ty)))
  ))
  (alias export $webgpu "[constructor]record-gpu-pipeline-constant-value" (func $ctor))
  (alias export $webgpu "[method]record-gpu-pipeline-constant-value.values" (func $meth))
