...
;; Guest constructs record then add (empty key, none value); harness 1. L2 unused (lift-only).
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (type $meth-ty (func (param "self" $borrow-rec) (param "key" string) (param "value" $opt-u64)))
    (export "[method]record-option-gpu-size64.add" (func (type $meth-ty)))
  ))
  (alias export $webgpu "[constructor]record-option-gpu-size64" (func $ctor))
  (alias export $webgpu "[method]record-option-gpu-size64.add" (func $meth))
  ...
  (core module $m
    ...
    (import "" "meth" (func $meth (param i32 i32 i32 i32 i64)))
    (func (export "run") (result i32)
      (call $meth (call $ctor) (i32.const 0) (i32.const 0) (i32.const 0) (i64.const 0))
      (i32.const 1)
    )
  )
