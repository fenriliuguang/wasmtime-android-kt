;; S6+: get-adapter-info + [method]gpu-adapter-info.device
;; L2 described adapter handle → device (Cpu stub cpu-device); harness 1.
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (export "[method]gpu-adapter-info.device" (func (type $ty)))
  ...
  (alias export $webgpu "[method]gpu-adapter-info.device" (func $device))
  ...
  (core module $m
    ...
    (import "" "device" (func $device (param i32 i32)))
    (func (export "run") (result i32)
      (call $device (call $get-info) (i32.const 0))
      (i32.const 1)
    )
  )
