...
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (export "[method]gpu-render-bundle-encoder.draw-indexed-indirect" (func (type $draw-ty)))
  ...
  (alias export $webgpu "[method]gpu-render-bundle-encoder.draw-indexed-indirect" (func $draw-iind))

  (core func $ge_lower (canon lower (func $get-encoder)))
  (core func $gb_lower (canon lower (func $get-buffer)))
  (core func $d_lower (canon lower (func $draw-iind)))
  ...
  (core module $m
    ...
    (import "" "draw-iind" (func $draw-iind (param i32 i32 i64)))
    ...
    (func (export "run") (result i32)
      ...
      (call $draw-iind (local.get $encoder) (local.get $buf) (i64.const 0))
