...
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (type $set-ty (func
      ...
      (param "size" $opt-u64)))
    (export "[method]gpu-render-bundle-encoder.set-index-buffer" (func (type $set-ty)))
  ...
  (alias export $webgpu "[method]gpu-render-bundle-encoder.set-index-buffer" (func $set-ib))
