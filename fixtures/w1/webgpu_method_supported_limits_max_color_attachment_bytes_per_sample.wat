...
;; WIT: max-color-attachment-bytes-per-sample: func() -> u32. Host returns 1; harness 1.
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (export "[method]gpu-supported-limits.max-color-attachment-bytes-per-sample" (func (type $ty)))
  ...
  (alias export $webgpu "[method]gpu-supported-limits.max-color-attachment-bytes-per-sample" (func $meth))
