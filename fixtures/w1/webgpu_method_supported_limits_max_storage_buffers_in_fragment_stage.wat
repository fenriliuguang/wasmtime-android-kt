;; L2: get-supported-limits + [method]gpu-supported-limits.max-storage-buffers-in-fragment-stage
;; WIT: max-storage-buffers-in-fragment-stage: func() -> u32. Host returns 1; harness 1.
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (export "[method]gpu-supported-limits.max-storage-buffers-in-fragment-stage" (func (type $ty)))
  ...
  (alias export $webgpu "[method]gpu-supported-limits.max-storage-buffers-in-fragment-stage" (func $meth))
