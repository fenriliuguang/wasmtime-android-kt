...
;; WIT: max-compute-workgroup-size-y: func() -> u32. Host returns 1; harness 1.
;; L2 unused (lift-only).
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (export "[method]gpu-supported-limits.max-compute-workgroup-size-y" (func (type $ty)))
  ...
  (alias export $webgpu "[method]gpu-supported-limits.max-compute-workgroup-size-y" (func $meth))
