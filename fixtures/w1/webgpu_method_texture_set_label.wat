...
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (type $set-ty (func
      ...
      (param "label" string)))
    (export "[method]gpu-texture.set-label" (func (type $set-ty)))
    (type $own-tex (own $gpu-texture))
    (export "get-texture" (func (result $own-tex)))
  ))
  (alias export $webgpu "get-texture" (func $get-tex))
  (alias export $webgpu "[method]gpu-texture.set-label" (func $set-label))
  ...
  (core module $m
    ...
    (func (export "run") (result i32)
      (call $set-label (call $get-tex) (i32.const 0) (i32.const 0))
      (i32.const 1)
    )
  )
