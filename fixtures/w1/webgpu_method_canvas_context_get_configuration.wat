...
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (type $owned-def (record
      (field "device" $own-device)
      (field "format" 1)
    ...
    (export "gpu-canvas-configuration-owned" (type (eq $owned-def)))
    (type $opt-owned (option 23))
    (type $borrow-ctx (borrow $gpu-canvas-context))
    (type $get-ty (func (param "self" $borrow-ctx) (result $opt-owned)))
    (export "[method]gpu-canvas-context.get-configuration" (func (type $get-ty)))
  ...
  (alias export $webgpu "[method]gpu-canvas-context.get-configuration" (func $get-cfg))
  ...
  (core func $gcfg_lower
    (canon lower (func $get-cfg)
      (memory $builtins "mem")
  ...
  (core module $m
    ...
    (import "" "get-configuration" (func $get-cfg (param i32 i32)))
    (func (export "run") (result i32)
      ;; result pointer 0 for option<record>
      (call $get-cfg (call $get-ctx) (i32.const 0))
      (i32.const 1)
    )
  )
  (core instance $i (instantiate $m
    (with "" (instance
      ...
      (export "get-configuration" (func $gcfg_lower))
    ))
  ))
