...
;; Host may bind an Android window; guest names stay gpu-canvas-context.*
;; (no product surface-*). get-* ctors are test-only. Harness 1.
  ...
  (core module $m
    ...
    (func (export "run") (result i32)
      ...
      (call $configure
        ...
        (i32.const 0) (i32.const 0) (i32.const 0)
        (i32.const 0) (i32.const 0))
      (call $drop-texture (call $get-tex (local.get $ctx)))
      (i32.const 1)
    )
  )
