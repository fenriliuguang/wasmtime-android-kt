...
;; WIT: max-uniform-buffer-binding-size: func() -> u64. Host returns 1; harness 1.
;; L2 unused (lift-only).
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (type $ty (func (param "self" $borrow-limits) (result u64)))
    (export "[method]gpu-supported-limits.max-uniform-buffer-binding-size" (func (type $ty)))
  ...
  (alias export $webgpu "[method]gpu-supported-limits.max-uniform-buffer-binding-size" (func $meth))
  ...
  (core module $m
    ...
    (import "" "meth" (func $meth (param i32) (result i64)))
