...
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (type $pair (tuple string $opt-u64))
    (type $list-pair (list $pair))
    (type $meth-ty (func (param "self" $borrow-rec) (result $list-pair)))
    (export "[method]record-option-gpu-size64.entries" (func (type $meth-ty)))
  ))
  (alias export $webgpu "[constructor]record-option-gpu-size64" (func $ctor))
  (alias export $webgpu "[method]record-option-gpu-size64.entries" (func $meth))
