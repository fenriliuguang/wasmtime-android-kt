...
;; Guest add key="c" value=1.0; layout=auto; label="l2"; drop pipeline; harness 1.
...
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (export "[constructor]record-gpu-pipeline-constant-value" (func (result $own-const)))
    (type $borrow-const (borrow $record-const))
    (type $add-ty (func (param "self" $borrow-const) (param "key" string) (param "value" f64)))
    (export "[method]record-gpu-pipeline-constant-value.add" (func (type $add-ty)))
  ))
  ...
  (alias export $webgpu "[method]record-gpu-pipeline-constant-value.add" (func $add))
  ...
  (core module $m
    ...
    (import "" "add" (func $add (param i32 i32 i32 f64)))
    (import "" "create-cp"
      (func $create-cp
    ...
    (func (export "run") (result i32)
      ...
      (call $add (local.get $rec) (i32.const 64) (i32.const 1) (f64.const 1))
      (local.set $pipeline
        (call $create-cp
          (local.get $device)
          (local.get $shader)
