...
;; S6+: get-texture + [method]gpu-texture.depth-or-array-layers
;; WIT: depth-or-array-layers: func() -> u32. Host returns 1; harness 1.
;; L2 described texture handle → depth-or-array-layers (stub 1×1 when get-texture rep=0).
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (export "[method]gpu-texture.depth-or-array-layers" (func (type $ty)))
    (type $own-tex (own $gpu-texture))
    (export "get-texture" (func (result $own-tex)))
  ))
  (alias export $webgpu "get-texture" (func $get-tex))
  (alias export $webgpu "[method]gpu-texture.depth-or-array-layers" (func $meth))
