;; S1–S3 leftover: get-adapter + [constructor]record-option-gpu-size64 + add
;; + [method]gpu-adapter.request-device with required-limits some + label="l2".
;; Guest add key="max-bind-groups" some(4); drops own device on ok; harness 1.
...
(component
  ...
  (core module $m
    ...
    (data (i32.const 64) "max-bind-groups")
    (func (export "run") (result i32)
      ...
      (call $add (local.get $rec) (i32.const 64) (i32.const 15) (i32.const 1) (i64.const 4))
      (call $request-device
        (local.get $adapter)
        (i32.const 1)
