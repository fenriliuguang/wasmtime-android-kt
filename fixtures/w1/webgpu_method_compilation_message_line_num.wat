...
;; WIT: line-num: func() -> u64. Host returns 0; harness 1. L2 unused (lift-only).
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (export "[method]gpu-compilation-message.line-num" (func (type $ty)))
  ...
  (alias export $webgpu "[method]gpu-compilation-message.line-num" (func $line-num))

  (core func $gm_lower (canon lower (func $get-msg)))
  (core func $l_lower (canon lower (func $line-num)))

  (core module $m
    (import "" "get-msg" (func $get-msg (result i32)))
    (import "" "line-num" (func $line-num (param i32) (result i64)))
    (func (export "run") (result i32)
      (drop (call $line-num (call $get-msg)))
      (i32.const 1)
    )
  )
