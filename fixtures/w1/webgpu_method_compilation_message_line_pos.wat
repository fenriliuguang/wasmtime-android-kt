;; S6+: get-compilation-message + [method]gpu-compilation-message.line-pos
;; WIT: line-pos: func() -> u64. Host returns 0; harness 1. L2 unused (lift-only).
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (export "[method]gpu-compilation-message.line-pos" (func (type $ty)))
  ...
  (alias export $webgpu "[method]gpu-compilation-message.line-pos" (func $line-pos))

  (core func $gm_lower (canon lower (func $get-msg)))
  (core func $l_lower (canon lower (func $line-pos)))

  (core module $m
    (import "" "get-msg" (func $get-msg (result i32)))
    (import "" "line-pos" (func $line-pos (param i32) (result i64)))
    (func (export "run") (result i32)
      (drop (call $line-pos (call $get-msg)))
      (i32.const 1)
    )
  )
