;; S6+: get-render-pipeline + [method]gpu-render-pipeline.label
...
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (export "[method]gpu-render-pipeline.label" (func (type $ty)))
  ...
  (alias export $webgpu "[method]gpu-render-pipeline.label" (func $label))
