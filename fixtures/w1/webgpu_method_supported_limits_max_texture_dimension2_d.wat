;; L2: get-supported-limits + [method]gpu-supported-limits.max-texture-dimension2-d
;; WIT: max-texture-dimension2-d: func() -> u32. Host returns 1; harness 1.
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (export "[method]gpu-supported-limits.max-texture-dimension2-d" (func (type $ty)))
  ...
  (alias export $webgpu "[method]gpu-supported-limits.max-texture-dimension2-d" (func $meth))
