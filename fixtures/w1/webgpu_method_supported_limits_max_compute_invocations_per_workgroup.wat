...
;; WIT: max-compute-invocations-per-workgroup: func() -> u32. Host returns 1; harness 1.
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (export "[method]gpu-supported-limits.max-compute-invocations-per-workgroup" (func (type $ty)))
  ...
  (alias export $webgpu "[method]gpu-supported-limits.max-compute-invocations-per-workgroup" (func $meth))
