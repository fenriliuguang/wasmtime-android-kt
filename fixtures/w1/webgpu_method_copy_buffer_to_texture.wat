...
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (export "gpu-texel-copy-buffer-info" (type (eq $src)))
    ...
    (type $copy-ty (func
      ...
      (param "copy-size" 18)))
    (export "[method]gpu-command-encoder.copy-buffer-to-texture" (func (type $copy-ty)))
  ...
  (alias export $webgpu "[method]gpu-command-encoder.copy-buffer-to-texture" (func $copy))
  ...
  (core module $m
    ...
    (func (export "run") (result i32)
      ...
      ;; Memory tuple: encoder@0, buffer-info@8 (buffer@8), texture-info@48
      ;; (texture@48), extent@92 (width=1, height/depth some 1)
      (i32.store (i32.const 0) (local.get $enc))
      (i32.store (i32.const 8) (local.get $buf))
      (i32.store (i32.const 48) (local.get $tex))
