...
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (type $opt-opt-u64 (option $opt-u64))
    (type $meth-ty (func (param "self" $borrow-rec) (param "key" string) (result $opt-opt-u64)))
    (export "[method]record-option-gpu-size64.get" (func (type $meth-ty)))
  ))
  (alias export $webgpu "[constructor]record-option-gpu-size64" (func $ctor))
  (alias export $webgpu "[method]record-option-gpu-size64.get" (func $meth))
