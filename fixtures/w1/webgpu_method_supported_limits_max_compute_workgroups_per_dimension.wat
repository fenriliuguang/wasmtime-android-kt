...
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (export "[method]gpu-supported-limits.max-compute-workgroups-per-dimension" (func (type $ty)))
  ...
  (alias export $webgpu "[method]gpu-supported-limits.max-compute-workgroups-per-dimension" (func $meth))
