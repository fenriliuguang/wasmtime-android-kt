...
;; S6+: get-texture + [method]gpu-texture.width
;; WIT: width: func() -> u32. Host returns 1; harness 1.
;; L2 described texture handle → width (stub 1×1 when get-texture rep=0).
(component
