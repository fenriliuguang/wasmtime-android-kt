...
(component
  (import "wasi:webgpu/webgpu@0.3.0-rc.2" (instance $webgpu
    ...
    (export "[method]gpu-render-pass-encoder.draw-indexed-indirect" (func (type $draw-ty)))
  ...
  (alias export $webgpu "[method]gpu-render-pass-encoder.draw-indexed-indirect" (func $draw-ixi))

  (core func $gp_lower (canon lower (func $get-pass)))
  (core func $gb_lower (canon lower (func $get-buffer)))
  (core func $d_lower (canon lower (func $draw-ixi)))
  ...
  (core module $m
    ...
    (import "" "draw-ixi" (func $draw-ixi (param i32 i32 i64)))
    ...
    (func (export "run") (result i32)
      ...
      (call $draw-ixi (local.get $pass) (local.get $buf) (i64.const 0))
