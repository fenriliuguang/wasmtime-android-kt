//! S6+: `get-supported-limits` + `[method]gpu-supported-limits.max-texture-dimension2-d`
...
#[test]
fn wasi_webgpu_method_supported_limits_max_texture_dimension2_d_smoke() -> wasmtime::Result<()> {
    ...
    let bytes = std::fs::read(concat!(
        ...
        "/../fixtures/w1/webgpu_method_supported_limits_max_texture_dimension2_d.wasm"
    ))?;
