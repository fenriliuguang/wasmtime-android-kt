...
1. Read [`docs/agent/wasmtime-p2.md`](docs/agent/wasmtime-p2.md).
2. Run `python3 ./scripts/wasmtime-p2-remaining.py`. Do **only** that printed **Next:** (often empty).
3. Do **not** re-cut P0/P1. Never file upstream GitHub issues. No major without a short RFC.
