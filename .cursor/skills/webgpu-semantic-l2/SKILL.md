...
4. Do not WebFetch WIT. Grep `third_party/wasi-webgpu/v0.3.0-rc.2/wit/webgpu.wit`. Windowed Read of `cm.rs` / `jvm.rs` / callbacks. Never file GitHub issues on wasi-webgpu, Wasmtime, or any other upstream.
