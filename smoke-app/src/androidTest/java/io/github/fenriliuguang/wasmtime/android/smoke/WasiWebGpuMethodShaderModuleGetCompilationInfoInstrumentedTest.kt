...
class WasiWebGpuMethodShaderModuleGetCompilationInfoInstrumentedTest {
    @Test
    fun guestShaderModuleGetCompilationInfoViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_shader_module_get_compilation_info.wasm")
                .use { it.readBytes() }
