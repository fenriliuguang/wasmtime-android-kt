...
/** S6+ `[method]gpu-adapter.features` via [ExperimentalWebGpuBridge.attachAdapterInfo]. */
@RunWith(AndroidJUnit4::class)
class WasiWebGpuMethodAdapterFeaturesInstrumentedTest {
    @Test
    fun guestAdapterFeaturesViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_adapter_features.wasm")
                .use { it.readBytes() }
