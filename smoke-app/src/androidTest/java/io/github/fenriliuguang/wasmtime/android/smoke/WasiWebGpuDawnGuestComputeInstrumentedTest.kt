...
/**
 * WG-6: canonical `[method]` guest compute on [DawnWasiWebGpuHost]
 * (not Cpu, not empty begin-compute-pass). Guest chains BGL + bind-group +
 * compute pipeline + set-bind-group + dispatch-workgroups + submit.
