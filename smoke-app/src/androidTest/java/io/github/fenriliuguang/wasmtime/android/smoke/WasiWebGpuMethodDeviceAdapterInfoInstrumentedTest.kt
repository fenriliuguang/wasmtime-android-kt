...
/** L2 `[method]gpu-device.adapter-info` via [ExperimentalWebGpuBridge.attachDeviceInfoError]. */
@RunWith(AndroidJUnit4::class)
class WasiWebGpuMethodDeviceAdapterInfoInstrumentedTest {
    @Test
    fun guestDeviceAdapterInfoViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_device_adapter_info.wasm")
                .use { it.readBytes() }
