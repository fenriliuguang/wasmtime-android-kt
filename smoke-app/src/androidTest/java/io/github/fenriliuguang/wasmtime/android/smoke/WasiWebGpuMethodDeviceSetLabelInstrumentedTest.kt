...
/** L2 `[method]gpu-device.set-label` via [ExperimentalWebGpuBridge.attachDeviceInfoError]. */
@RunWith(AndroidJUnit4::class)
class WasiWebGpuMethodDeviceSetLabelInstrumentedTest {
    @Test
    fun guestDeviceSetLabelViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_device_set_label.wasm")
                .use { it.readBytes() }
