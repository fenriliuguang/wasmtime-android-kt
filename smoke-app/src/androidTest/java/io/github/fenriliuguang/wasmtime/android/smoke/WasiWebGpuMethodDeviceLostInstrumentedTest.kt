...
/** S6+ `[method]gpu-device.lost` via [ExperimentalWebGpuBridge.attachDeviceInfoError]. */
@RunWith(AndroidJUnit4::class)
class WasiWebGpuMethodDeviceLostInstrumentedTest {
    @Test
    fun guestDeviceLostViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_device_lost.wasm")
                .use { it.readBytes() }
