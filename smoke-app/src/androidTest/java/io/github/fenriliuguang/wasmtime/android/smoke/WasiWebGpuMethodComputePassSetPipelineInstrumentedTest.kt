...
class WasiWebGpuMethodComputePassSetPipelineInstrumentedTest {
    @Test
    fun guestComputePassSetPipelineViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_compute_pass_set_pipeline.wasm")
                .use { it.readBytes() }
