...
class WasiWebGpuMethodSupportedLimitsMaxComputeInvocationsPerWorkgroupInstrumentedTest {
    @Test
    fun guestSupportedLimitsMaxComputeInvocationsPerWorkgroupViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_supported_limits_max_compute_invocations_per_workgroup.wasm")
                .use { it.readBytes() }
