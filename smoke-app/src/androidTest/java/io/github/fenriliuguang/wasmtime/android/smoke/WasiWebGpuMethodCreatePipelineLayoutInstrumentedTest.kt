...
/** W3+ `[method]gpu-device.create-pipeline-layout` via [ExperimentalWebGpuBridge.attachCreatePipelineLayout]. */
                    ...
                    Linker.create(engine).use { linker ->
                        Store.create(engine).use { store ->
                            ...
                            linker.instantiate(store, component).use { instance ->
                                ...
                                assertNotEquals("pipeline-layout rep must be non-zero", 0, rep)
                                assertTrue("pipeline-layout rep should be positive", rep > 0)
                            }
                        }
                    }
                }
