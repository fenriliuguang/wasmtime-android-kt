...
class WasiWebGpuMethodUncapturedErrorEventErrorInstrumentedTest {
    @Test
    fun guestUncapturedErrorEventErrorViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_uncaptured_error_event_error.wasm")
                .use { it.readBytes() }
