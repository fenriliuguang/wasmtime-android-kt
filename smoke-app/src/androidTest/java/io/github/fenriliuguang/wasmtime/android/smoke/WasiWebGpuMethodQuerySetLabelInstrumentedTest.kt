...
/** L2 `[method]gpu-query-set.label` via [ExperimentalWebGpuBridge.attachDeviceQueryAndDestroy]. */
@RunWith(AndroidJUnit4::class)
class WasiWebGpuMethodQuerySetLabelInstrumentedTest {
    @Test
    fun guestQuerySetLabelViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_query_set_label.wasm")
                .use { it.readBytes() }
