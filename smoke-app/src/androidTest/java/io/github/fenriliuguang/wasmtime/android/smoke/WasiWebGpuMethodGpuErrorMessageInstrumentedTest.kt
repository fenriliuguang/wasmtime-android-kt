...
/** L2 `[method]gpu-error.message` via [ExperimentalWebGpuBridge.attachDeviceInfoError]. */
@RunWith(AndroidJUnit4::class)
class WasiWebGpuMethodGpuErrorMessageInstrumentedTest {
    @Test
    fun guestGpuErrorMessageViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_gpu_error_message.wasm")
                .use { it.readBytes() }
