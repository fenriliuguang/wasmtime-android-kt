...
/** L2 `[method]gpu-device.label` via [ExperimentalWebGpuBridge.attachDeviceInfoError]. */
@RunWith(AndroidJUnit4::class)
class WasiWebGpuMethodDeviceLabelInstrumentedTest {
    @Test
    fun guestDeviceLabelViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_device_label.wasm")
                .use { it.readBytes() }
