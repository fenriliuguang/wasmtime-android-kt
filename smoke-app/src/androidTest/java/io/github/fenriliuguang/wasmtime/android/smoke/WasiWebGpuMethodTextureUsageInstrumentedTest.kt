...
/** L2 `[method]gpu-texture.usage` via [ExperimentalWebGpuBridge.attachTextureInfo]. */
@RunWith(AndroidJUnit4::class)
class WasiWebGpuMethodTextureUsageInstrumentedTest {
    @Test
    fun guestTextureUsageViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_texture_usage.wasm")
                .use { it.readBytes() }
