...
class WasiWebGpuMethodComputePassDispatchWorkgroupsIndirectInstrumentedTest {
    @Test
    fun guestComputePassDispatchWorkgroupsIndirectViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_compute_pass_dispatch_workgroups_indirect.wasm")
                .use { it.readBytes() }
