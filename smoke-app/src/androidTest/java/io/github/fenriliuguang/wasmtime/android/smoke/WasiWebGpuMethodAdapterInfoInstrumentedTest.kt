...
/** S6+ `[method]gpu-adapter.info` via [ExperimentalWebGpuBridge.attachAdapterInfo]. */
@RunWith(AndroidJUnit4::class)
class WasiWebGpuMethodAdapterInfoInstrumentedTest {
    @Test
    fun guestAdapterInfoViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_adapter_info.wasm")
                .use { it.readBytes() }
