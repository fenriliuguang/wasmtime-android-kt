...
/** L2 `[method]gpu-command-buffer.label` via [ExperimentalWebGpuBridge.attachCommandCompilationLabel]. */
@RunWith(AndroidJUnit4::class)
class WasiWebGpuMethodCommandBufferLabelInstrumentedTest {
    @Test
    fun guestCommandBufferLabelViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_command_buffer_label.wasm")
                .use { it.readBytes() }
