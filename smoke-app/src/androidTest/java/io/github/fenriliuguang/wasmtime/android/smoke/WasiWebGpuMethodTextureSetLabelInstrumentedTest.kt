...
/** L2 `[method]gpu-texture.set-label` via [ExperimentalWebGpuBridge.attachTextureInfo]. */
@RunWith(AndroidJUnit4::class)
class WasiWebGpuMethodTextureSetLabelInstrumentedTest {
    @Test
    fun guestTextureSetLabelViaMethodNameSync() {
        val bytes =
            InstrumentationRegistry.getInstrumentation()
                .context
                .assets
                .open("w1/webgpu_method_texture_set_label.wasm")
                .use { it.readBytes() }
