...
private class ForwardingHostCallbacks(
    ...
    override fun bindGroupLabelDescribed(bind_group: Int): String = bindings.bindGroupLabel(bind_group)

    override fun bindGroupSetLabelDescribed(bind_group: Int, label: String) {
    ...
    override fun textureViewLabelDescribed(handle: Int): String = bindings.textureViewLabel(handle)
    ...
    override fun queueLabelDescribed(handle: Int): String = bindings.queueLabel(handle)
    ...
    override fun commandBufferLabelDescribed(handle: Int): String = bindings.commandBufferLabel(handle)

    override fun commandBufferSetLabelDescribed(handle: Int, label: String) {
        bindings.commandBufferSetLabel(handle, label)
    }

    override fun computePassEncoderLabelDescribed(handle: Int): String = bindings.computePassEncoderLabel(handle)

    override fun computePassEncoderSetLabelDescribed(handle: Int, label: String) {
        bindings.computePassEncoderSetLabel(handle, label)
    }

    override fun computePipelineLabelDescribed(handle: Int): String = bindings.computePipelineLabel(handle)
    ...
    override fun renderBundleLabelDescribed(handle: Int): String = bindings.renderBundleLabel(handle)
    ...
    override fun renderPipelineLabelDescribed(handle: Int): String = bindings.renderPipelineLabel(handle)
