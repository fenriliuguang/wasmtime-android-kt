...
| **L5 / 0.1.0** | 产品子集 + **完整** gfx 循环（剩余 **P010-GFXB** / **P010-GFXV**）（[`product-010.md`](docs/agent/product-010.md)） |

成功标准：[`rfc-ecosystem-contribution.zh.md`](docs/scheme/rfc-ecosystem-contribution.zh.md) — 可复现、可引用；**禁止**向上游开 GitHub issue。GPU 接线：[`rfc-pluggable-gpu-backend.zh.md`](docs/scheme/rfc-pluggable-gpu-backend.zh.md)。**P0 与 P1 已关闭。** **`0.1.0` 剩余：** 完整 gfx 帧循环（**P010-GFXB** → **P010-GFXV**）。P2 Wasmtime 钉为点名。
