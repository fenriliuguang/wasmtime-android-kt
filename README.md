...
| **L5 / 0.1.0** | Product subset + **complete** gfx loop (**P010-GFXB** / **P010-GFXV** remaining) ([`product-010.md`](docs/agent/product-010.md)) |

Success criteria (2026-08-17, amended 2026-08-21): [`rfc-ecosystem-contribution.md`](docs/scheme/rfc-ecosystem-contribution.md) — reproducible, citable; **do not** file upstream GitHub issues. **P0 and P1 are closed.** **`0.1.0` remaining:** complete gfx frame loop (**P010-GFXB** → **P010-GFXV**). P2 Wasmtime pin is **named**.
...
| [0.1.0 playbook](docs/agent/product-010.md) | L5 product gates (**Next:** complete gfx loop) |
